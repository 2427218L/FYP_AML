...
if __name__ == '__main__':
    ...
    #X, Y = read_reverse_engineer(net, './revengimg')
    with open('X.pkl', 'wb') as f:
        pickle.dump((X, Y), f)
    X_test, Y_test = read_original(net, './sized_images_random')
    #X_test, Y_test = read_original(net, './sizeimgrand')
    with open('X_test.pkl', 'wb') as f:
        pickle.dump((X_test, Y_test), f)
    #A, A_Y = read_trojan(net, './filteredtrue')
    ...
    #A_test, A_Y_test = read_trojan(net, './filteredrand')
    ...
    #O_test, O_Y_test = read_trojan(net, './filteredtop1k')
    with open('O_test.pkl', 'wb') as f:
        pickle.dump((O_test, O_Y_test), f)

    pkl_name = './fc6_params.pkl'
